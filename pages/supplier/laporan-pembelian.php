...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div id="reportContent">
                        <div class="kop-surat">
                            <img src="../../img/total fitnes.png" alt="Logo Toko">
                            <div class="header-info" style="margin-left: -150px;">
                                <h1 style="color: black; font-weight: bold;">Total Fitness</h1>
                                <p style="color: black; font-weight: bold;">Jl. Peternakan 3 No. 551, Jakarta Barat</p>
                                <p style="color: black; font-weight: bold;">+62 856-1994-447</p>
                            </div>
                        </div>
                        <hr>
                        <div style="text-align: center;">
                            ...
                            <div class="signature-section">
                                <div class="signature">
                                    ...
                                    <p><strong>Yudi Hartono</strong></p>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function generatePDF() {
            ...
            var opt = {
                margin: 1,
                filename: 'laporan_transaksi_penjualan_totalFitness.pdf',
                image: {
                    type: 'jpeg',
                    quality: 0.98
                },
